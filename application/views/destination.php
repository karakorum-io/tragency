...
<head>
    <title>Expedition Saga |
        <?= $dest_detail->name ?>
    </title>
    <meta name="description" content="Destination short description">
    <meta property="og:title" content=" <?= $dest_detail->name ?>" />
    <meta property="og:description" content="Destination login description" />
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#menu1">Tour Packages</a></li>
                    </ul>
