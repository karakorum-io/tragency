            ...
            if($tour->num_rows()>0){
                ...
                foreach($tour->result() as $row){
                 ?>
                        ...
                        <a href="<?=base_url()?>tours/<?=urlencode(str_replace(' ', '-', $row->name))?>/<?=$row->id?>">  <div class="single-destinations-list style-three">
                            <div class="thumb">
                                 <?php if($row->sale!=0)echo'<span class="d-list-tag">'.$row->sale.'% Off</span>';?>
                            ...
                            <div class="details">
                                ...
                                <div class="list-price-meta">
                                    <ul class="tp-list-meta d-inline-block">
                                        <li><i class="fa fa-clock-o"></i> <?=$row->duration?></li>
                                       
                                    </ul>
                                    <div class="tp-price-meta d-inline-block">
                                        <p>Price</p>
                                        <h2 class="price">From <?php if($row->sale!=0)echo'<del>'.$settings->currency_symbol.$row->tour_price.'</del>';?> <b><?=$settings->currency_symbol.$row->price?></b></h2>
                                    </div>
                                </div>
                    ...
                    <div class="sidebar-area">
                        <div class="widget tour-list-widget">
                            ...
                            <div class="widget-tour-list-meta">
                                <div class="single-widget-search-input-title mt-3"><i class="fa fa-dot-circle-o"></i> Destinations</div>
                                ...
                                <div class="single-widget-search-input-title mt-3"><i class="fa fa-usd"></i> Price Filter</div>
