                            ...
                            <div class="col-lg-12">
                                <div class="card mb-3">
                                    <div class="card-header">
                                        <h1 class=" h5 mr-2"><b>Add User</b></h1>
                                    </div>
                                    <div class="card-body">
                                        <?php $this->load->view('admin/include/message-alert'); ?>
                                        <form id="addUser" action="<?= base_url('admin/users/add') ?>" method="post"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-3">
                                                    ...
                                                    <select onchange="getStates(this.value)" class="form-control" name="country">
