...
<body class="text-left">
    <div class="app-admin-wrap layout-sidebar-large">
        ...
        <form action = "<?=base_url('master/add_product_action')?>" method = "post" enctype='multipart/form-data'>
                    ...
                    <div class="offset-lg-2 col-lg-8">
                        ...
                        <div class="card mb-3">
                             <div class="card-header text-center">
                                 <h1 class=" h5 mr-2"><b>Add New Tour</b></h1>
                             </div> 
                            <div class="card-body"> 
   ...
   <div class="form-group col-sm-12">
      <div style="    border: 1px solid #ddd;background: #f2f2f2;padding:5px">                           
                             ...
                             <div class="form-group col-sm-12">
                              ...
                              <div class="form-group col-sm-12">
                               <textarea name="map" rows="4" class="form-control " required placeholder="Location"></textarea>
                            </div>
                             <div class="form-group col-sm-6">
