...
<body class="text-left">
    <div class="app-admin-wrap layout-sidebar-large">
        ...
        <form action = "<?=base_url('master/edit_category_action')?>" method = "post" enctype='multipart/form-data'>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body"> 
                             ...
                             <div class="form-group col-sm-12">
                                ...
                                <input name="name"  value="<?=$row->name?>" class="form-control " id="email" type="text" required="">
                            </div>
                              <div class="form-group col-sm-6">
                                        <label class="form-label">Add Image</label>
                                         ...
                                         <div class="form-group col-sm-6"> <img class="img-thumbnail" style="    height: 103px;width: auto;" src="<?=base_url()?><?=$row->image;?>"></div>
 ...
 <i class="nav-icon i-Map-Marker"></i> Use Map
     ...
     <span id='message'></span> 
                                ...
                                <input name="latitude" value="<?=$row->latitude?>" class="form-control " id="lat" type="text" required="">
                            </div>
                             <div class="form-group col-sm-6">
                                <label for="email">Longitude</label>
                                <input name="longitude" value="<?=$row->longitude?>" class="form-control " id="lng" type="text" required="">
                            </div>
                                           <div class="form-group col-sm-12">
                            ...
                            <div class="form-group col-sm-12">
                                <label for="email">Weather</label>
                                 <textarea name="weather" class="form-control"  required=""><?=$row->weather?></textarea>
