                            ...
                            <div class="col-lg-12">
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="add" action="<?php echo $this->controllerUrl ?>edit/<?php echo $blog->id?>" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <input name="slug" class="form-control" value="<?php echo $blog->slug?>" type="text" required />
                                                </div>
                                                ...
                                                <div class="form-group col-sm-6">
                                                    <img class="img-thumbnail"
                                                        ...
                                                        src="<?php echo base_url() ?>uploads/blogs/<?php echo $blog->media; ?>"
                                                    />
                                                </div>
                                                <div class="form-group col-sm-12">
                                                    <label for="short_description">Short Description</label>
                                                    <input name="short_description" class="form-control" type="text" 
                                                        value="<?php echo $blog->short_description?>" required />
                                                </div>
                                                <div class="form-group col-sm-12">
                                                    <label for="email">Description</label>
                                                    <textarea name="overview" class="form-control" required><?php echo $blog->description?></textarea>
                                                </div>
