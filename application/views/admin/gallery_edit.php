...
<body class="text-left">
    <div class="app-admin-wrap layout-sidebar-large">
        ...
        <form action = "<?=base_url('master/edit_gallery_action')?>" method = "post" enctype='multipart/form-data'>
                    ...
                    <div class="offset-lg-3 col-lg-6">
                        ...
                        <div class="card mb-3">
                             <div class="card-header text-center">
                                 <h1 class=" h5 mr-2"><b>Edit Blog</b></h1>
                             </div> 
                            <div class="card-body"> 
                            ...
                            <input type="file" name="img"  accept="image/*"    class="form-control " >
                             ...
                             <div class="form-group col-sm-12">
                                <label for="email">Long Description</label>
                                 <textarea name="descr" class="form-control"  required=""><?=$row->descr?></textarea>
