            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-inner ">
                        <h4 class="page-title">Login/Sign Up</h4>
                        <ul class="page-list">
        ...
        <div class="tour-details-gallery">
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                         <div class="col-sm-5">
                    <form class="box" action="<?=base_url()?>welcome/login" method="post">
                  
                        
                                <div class="single-widget-search-input">
                                     <div class="row">
                                    <div class="col-12">
                                        <div class="single-widget-search-input-title">Country Code</div>
<select name="countryCode" id="" required="" class="p-2" >
...
<div class="col-12">
    ...
    <input type="tel" name="phone" placeholder="Phone"></div>
                        ...
                        <div class="single-input-wrap style-two mt-4">
                            <button class="btn btn-yellow w-100">Submit</button>
                        </div>
