...
<head>
    ...
    <meta name="description" content="Expedition Saga | Blogs">
    <meta property="og:title" content="Expedition Saga | Blogs" />
    <meta property="og:description" content="Expedition Saga | Blogs" />
    <meta name="description" content="Get great offers on India holiday Packages at Expedition Saga - Truly Luxury. Book your vacations packages and holiday packages in India with us today." />
    <meta property="og:title" content="Expedition Saga - Truly Luxury Travel Agency" />
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        <h1 class="title wow animated fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.1s">
                            TRAVELOGUES</h1>
                    </div>
                </div>
            </div>
