	...
	<form method="POST" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="144724"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?=base_url()?>welcome/load/ccavResponseHandler"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?=base_url()?>welcome/load/ccavResponseHandler.php"/></td>
			 	</tr>
			 	<tr>
...
<!-- <script src="jquery-1.7.2.min.js"></script>-->
 <script language="javascript" type="text/javascript" src="<?=base_url()?>/assets/json.js"></script>
...
<script type="text/javascript">
  $(function(){
	 ...
	 */	  
  	  var jsonData;
  	  var access_code="AVEE81FK88CC54EECC" // shared by CCAVENUE 
	  var amount="6000.00";
  	  var currency="INR";
